...
// animation text's positions
const animatedText = [
    {
        id: 1,
        title: "100% Real Mango",
        description: "It all begins with perfectly ripe mangoes, selected for their natural sweetness and rich tropical flavor.",
        position: " absolute top-0 left-0"
    },
    {
        id: 2,
        title: "Pure Mango Flavor",
        description: "No complicated flavors. Just the unmistakable taste of real, juicy mango.",
